...
EXP_NAME = 'shape_interpolation_LipMLP_4'
...
class DataGen:
    ...
    def __init__(self, patient_name_list, spacing):
        ...
        sdf_list = [f"./sdt2sdf_best/8_64_{p}.pkl" for p in self.patient_name_list]
...
if __name__ == '__main__':
    name_list = ["patient009", "patient029", "patient069", "patient089"]

    # NN initialization
    task = ApproximateSDFLipMLP(batch_size=FLAT_SHAPE, model_number=len(name_list))
