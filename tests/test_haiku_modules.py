...
class HaikuModulesTestCase(BaseTestCase):
    ...
    def test_DescConv_init(self):
        ...
        params = init(rng_key, jnp.zeros((100, 16, 16, 16, 1)))
    ...
    def test_DescConv_relu_on_output(self):
        ...
        self.assertTrue(bool(jnp.all(result >= 0.0)))
    ...
    def test_LipLinear_output_type(self):
        def init(x):
            ll = LipLinear(
                output_size=(32, 32, 32, 32, 32, 32, 32, 1),
                name="lip_mlp_%d" % 2,
