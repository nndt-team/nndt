...
if __name__ == "__main__":
    ...
    space = spc.add_sphere(space, "domain", center=(0.0, 0.0, 0.0), radius=2.0)
    space = spc.add_sphere(space, "init_reg", center=(1.0, 0.0, 0.0), radius=1.0)
    print(space.print())
    ...
    xyz = space.domain.sampling_grid_with_noise(
        subkey, spacing=SHAPE, sigma=0.1
    ).reshape((-1, 3))
